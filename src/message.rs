...
#[derive(Clone, PartialEq, ::prost::Message, Encode, Decode, scale_info::TypeInfo)]
...
pub mod message_data {
    ...
    #[derive(Clone, PartialEq, ::prost::Oneof, Encode, Decode, scale_info::TypeInfo)]
    pub enum Body {
        #[prost(message, tag = "5")]
...
pub mod link_body {
    ...
    #[derive(Clone, Copy, PartialEq, ::prost::Oneof, Encode, Decode, scale_info::TypeInfo)]
    pub enum Target {
